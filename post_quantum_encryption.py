...
# Define a function to implement the ElGamal encryption algorithm
def elgamal_encryption(plain_text, p, g, h):
...
# Define a function to implement the ElGamal decryption algorithm
def elgamal_decryption(c1, c2, p, x):
    # Calculate the plain text
    plain_text = (c2 * pow(c1, p-1-x, p)) % p

    return plain_text

# Test the ElGamal encryption and decryption algorithms
if __name__ == "__main__":
    ...
    c1, c2 = elgamal_encryption(plain_text, p, g, h)
    print("Cipher text: ", (c1, c2))

    # Decrypt the cipher text
    decrypted_text = elgamal_decryption(c1, c2, p, x)
